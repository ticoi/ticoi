...
def loader_example(self, conf):
    ...
    sensor_raw = "to modify with str of list with the names of the sensors, could be in the form of S1, L8, L9, or Sentinel-1"
    sensors = self._standardize_sensor_names(sensor_raw)#convert to a long format type, like Sentinel-1, Landsat-8, etc
