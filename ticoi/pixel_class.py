...
class pixel_class:
    ...
    def plot_invert_interp_obs_residual(self, colors: List[str] = ["gray", 'steelblue', "#ec8559" ], type_data: str = "invert", block_plot: bool = True):
        ...
        ax.legend(loc="upper left", bbox_to_anchor=(0.001, 0.999), fontsize=14, frameon=False, handlelength=1, handletextpad=1)
        ...
        sns.boxenplot(data=residuals, ax=ax_inset, orient='h', color='steelblue', k_depth="proportion", alpha=0.9, line_kws=dict(linewidth=1.5), showfliers=False, zorder=10)
