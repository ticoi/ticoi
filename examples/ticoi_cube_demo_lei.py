...
flag_file = '/media/tristan/Data3/Hala_lake/glacier_outline/hala_lake_RGI7.shp'
dem_file = '/media/tristan/Data3/Hala_lake/Landsat8/hala_cop30_utm_30m.tif'
path_save = '/media/tristan/Data3/Hala_lake/Landsat8/test'  # Path where to stored the results
result_fn = 'test_topo_30'# Name of the netCDF file to be created
...
for common_parameter in ['flag','proj','delete_outliers','regu','solver']: inversion_kwargs[common_parameter] = preData_kwargs[common_parameter]
