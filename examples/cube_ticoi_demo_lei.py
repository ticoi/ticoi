...
# List of the paths where the data cubes are stored
cube_name = f"/media/tristan/Data3/Hala_lake/Landsat8/Hala_disp_LS7_LS8_refine_0819.nc"  # Path where the Sentinel-2 IGE cubes are stored
path_save = f"/media/tristan/Data3/Hala_lake/Landsat8/ticoi_test/test_0720"  # Path where to stored the results
result_fn = "Hala_disp_LS7_LS8_ticoi_flow_angle_disp_refine_6th_0819_2000_2020"  # Name of the netCDF file to be created
flag_shp = f"/media/tristan/Data3/Hala_lake/glacier_outline/Halla_lake_HMA_surging_inventory_GAMDAM.gpkg"
...
coef = {0: 400, 1: 300, 2: 200}  # Regularization coefficient.s to be used (for each flag if flag is not None)
...
preData_kwargs = {
    ...
    "select_baseline": 200,  # Select temporal baselines (in days) to be used for the smoothing
